        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/app" element={<AppLayout />}>
              ...
              <Route path="projects/:id/payments" element={<ProjectGuard><PermissionGuard module="payments"><BOQ /></PermissionGuard></ProjectGuard>} />
              <Route path="projects/:id/progress" element={<ProjectGuard><PermissionGuard module="progress"><Materials /></PermissionGuard></ProjectGuard>} />
